const criogen = extend(PlanetGenerator, {
    rawHeight(position){
...
crio.accessible = true;
crio.hasAtmosphere = true;
crio.atmosphereColor = Color.valueOf("f0e4a8");
crio.meshLoader = () => new HexMesh(zuila, 6);
